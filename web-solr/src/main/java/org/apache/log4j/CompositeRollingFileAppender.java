...
public class CompositeRollingFileAppender extends FileAppender {
	...
	/**
	 * The default constructor simply calls its FileAppender#FileAppender parents
	 * constructor.
	 */
	...
	public CompositeRollingFileAppender(Layout layout, String filename, String datePattern, boolean append)
			throws IOException {
		super(layout, filename, append);
		this.datePattern = datePattern;
		activateOptions();
	 ...
	 * 
	 * <p>
	 * This method is equivalent to #setMaxFileSize except that it is required for
	 * differentiating the setter taking a <code>long</code> argument from the
	 * setter taking a <code>String</code> argument by the JavaBeans
