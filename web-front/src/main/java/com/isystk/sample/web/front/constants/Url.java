/*
 */
package com.isystk.sample.web.front.constants;
...
public enum Url {
	...
	frontMember("/member/"),
	/** 投稿登録 */
	frontMemberPostRegist("/member/post/regist/"),
	/** 投稿修正 */
	frontMemberPostEdit("/member/post/edit/"),
	/** ログイン */
	frontLogin("/login/"),
	/** ログアウト */
	...
	frontEntry("/entry/"),
	/** 会員登録 */
	frontEntryRegist("/entry/regist/"),
	/** パスワードをお忘れの方はこちら */
	frontEntyRemind("/entry/remind/");
