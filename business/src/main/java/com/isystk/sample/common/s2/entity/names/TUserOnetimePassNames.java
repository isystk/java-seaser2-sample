...
public class TUserOnetimePassNames {
	 ...
	 * @author S2JDBC-Gen
	 */
	public static class _TUserOnetimePassNames extends PropertyName<TUserOnetimePass> {

		/**
		 * インスタンスを構築します。
		 */
		public _TUserOnetimePassNames() {
		}
		 ...
		 *            名前
		 */
		public _TUserOnetimePassNames(final String name) {
			super(name);
		}
		 ...
		 *            名前
		 */
		public _TUserOnetimePassNames(final PropertyName<?> parent, final String name) {
			super(parent, name);
		}
