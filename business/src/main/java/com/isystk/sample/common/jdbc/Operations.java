...
public class Operations extends org.seasar.extension.jdbc.operation.Operations {
	...
	/**
	 * MySQLの場合のNullを最後にした昇順の{@link OrderByItem}を作成します。 例えば、「order by prop IS NULL
	 * asc, prop asc」のようなOrderbyを構築することができます。
	 * 
	 * @param propertyName
	 *            プロパティ名
	...
	/**
	 * MySQLの場合のNull最初にした降順の{@link OrderByItem}を作成します。 例えば、「order by prop IS NULL
	 * desc, prop desc」のようなOrderbyを構築することができます。
	 * 
	 * @param propertyName
	 *            プロパティ名
