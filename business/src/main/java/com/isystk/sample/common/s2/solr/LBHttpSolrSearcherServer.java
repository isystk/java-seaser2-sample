...
/**
 *
 * core毎のLBHttpSolrServerのインスタンスを生成します。
 * solrへのリクエストはすべてこのクラスで生成されたインスタンスを使用する
 *
 * @author iseyoshitaka
 *
 */
public class LBHttpSolrSearcherServer {
	...
	try {
	    ...
	    postServer = new LBHttpSolrServer(masterUrl + PostSearchDto.CORE_NAME + "/", slaveUrl + PostSearchDto.CORE_NAME + "/");
