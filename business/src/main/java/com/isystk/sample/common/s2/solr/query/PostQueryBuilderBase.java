...
public class PostQueryBuilderBase {
	...
	public static QueryBuilder queryBuildBase(PostSearchDto.Searcher searcherDto) {
		...
		if (CollectionUtils.isNotEmpty(searcherDto.postIdBetweenAndList)) {
			qb.mustBetweenIntegerList(PostSearchDto.Searcher.POST_ID, searcherDto.postIdBetweenAndList,
					QueryBuilder.AND);
		}
		...
		if (CollectionUtils.isNotEmpty(searcherDto.userIdBetweenAndList)) {
			qb.mustBetweenIntegerList(PostSearchDto.Searcher.USER_ID, searcherDto.userIdBetweenAndList,
					QueryBuilder.AND);
		}
		...
		if (CollectionUtils.isNotEmpty(searcherDto.postImageIdListAndList)) {
			qb.mustIntegerList(PostSearchDto.Searcher.POST_IMAGE_ID_LIST, searcherDto.postImageIdListAndList,
					QueryBuilder.AND);
		}
		if (CollectionUtils.isNotEmpty(searcherDto.postImageIdListOrList)) {
			qb.mustIntegerList(PostSearchDto.Searcher.POST_IMAGE_ID_LIST, searcherDto.postImageIdListOrList,
					QueryBuilder.OR);
		}
		...
		if (CollectionUtils.isNotEmpty(searcherDto.postImageIdListBetweenAndList)) {
			qb.mustBetweenIntegerList(PostSearchDto.Searcher.POST_IMAGE_ID_LIST,
					searcherDto.postImageIdListBetweenAndList, QueryBuilder.AND);
		}
		if (CollectionUtils.isNotEmpty(searcherDto.postImageIdListBetweenOrList)) {
			qb.mustBetweenIntegerList(PostSearchDto.Searcher.POST_IMAGE_ID_LIST,
					searcherDto.postImageIdListBetweenOrList, QueryBuilder.OR);
		}
		...
		if (CollectionUtils.isNotEmpty(searcherDto.postTagIdListAndList)) {
			qb.mustIntegerList(PostSearchDto.Searcher.POST_TAG_ID_LIST, searcherDto.postTagIdListAndList,
					QueryBuilder.AND);
		}
		if (CollectionUtils.isNotEmpty(searcherDto.postTagIdListOrList)) {
			qb.mustIntegerList(PostSearchDto.Searcher.POST_TAG_ID_LIST, searcherDto.postTagIdListOrList,
					QueryBuilder.OR);
		}
		...
		if (CollectionUtils.isNotEmpty(searcherDto.postTagIdListBetweenAndList)) {
			qb.mustBetweenIntegerList(PostSearchDto.Searcher.POST_TAG_ID_LIST, searcherDto.postTagIdListBetweenAndList,
					QueryBuilder.AND);
		}
		if (CollectionUtils.isNotEmpty(searcherDto.postTagIdListBetweenOrList)) {
			qb.mustBetweenIntegerList(PostSearchDto.Searcher.POST_TAG_ID_LIST, searcherDto.postTagIdListBetweenOrList,
					QueryBuilder.OR);
		}
		...
		if (CollectionUtils.isNotEmpty(searcherDto.postTagNameListAndList)) {
			qb.mustStringList(PostSearchDto.Searcher.POST_TAG_NAME_LIST, searcherDto.postTagNameListAndList,
					QueryBuilder.AND);
		}
		if (CollectionUtils.isNotEmpty(searcherDto.postTagNameListOrList)) {
			qb.mustStringList(PostSearchDto.Searcher.POST_TAG_NAME_LIST, searcherDto.postTagNameListOrList,
					QueryBuilder.OR);
		}
		...
		if (CollectionUtils.isNotEmpty(searcherDto.registTimeBetweenAndList)) {
			qb.mustBetweenDateList(PostSearchDto.Searcher.REGIST_TIME, searcherDto.registTimeBetweenAndList,
					QueryBuilder.AND);
		}
		if (CollectionUtils.isNotEmpty(searcherDto.registTimeBetweenOrList)) {
			qb.mustBetweenDateList(PostSearchDto.Searcher.REGIST_TIME, searcherDto.registTimeBetweenOrList,
					QueryBuilder.OR);
		}
		...
		if (CollectionUtils.isNotEmpty(searcherDto.indexUpdateTimeOrList)) {
			qb.mustDateList(PostSearchDto.Searcher.INDEX_UPDATE_TIME, searcherDto.indexUpdateTimeOrList,
					QueryBuilder.OR);
		}
		...
		if (CollectionUtils.isNotEmpty(searcherDto.indexUpdateTimeBetweenAndList)) {
			qb.mustBetweenDateList(PostSearchDto.Searcher.INDEX_UPDATE_TIME, searcherDto.indexUpdateTimeBetweenAndList,
					QueryBuilder.AND);
		}
		if (CollectionUtils.isNotEmpty(searcherDto.indexUpdateTimeBetweenOrList)) {
			qb.mustBetweenDateList(PostSearchDto.Searcher.INDEX_UPDATE_TIME, searcherDto.indexUpdateTimeBetweenOrList,
					QueryBuilder.OR);
		}
