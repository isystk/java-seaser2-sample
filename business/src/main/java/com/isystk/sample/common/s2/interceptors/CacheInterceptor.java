...
//	java.util.Iterator<Map.Entry<CacheInfo, Result>> iter = conditionAndResultList.entrySet().iterator();
//	while (iter.hasNext()) {
//	    Map.Entry<CacheInfo, Result> temp = iter.next();
//
//	    System.out.println("C: " + temp.getKey().methodName + " - " + temp.getKey().arguments[0]);
//	}
//
...
//	System.out.println("CountOK: " + ((createcount - removecount) == (endsize - startSize)));
//	System.out.println();
     ...
     */
    private void reloadNewCache(CacheInfo cacheInfo, Result res) throws NoSuchMethodException, IllegalAccessException, InvocationTargetException {
	Object ths = componentDef.getComponent();
	Method method = componentDef.getComponentClass().getMethod(res.invocationMethodName, res.invocationMethodArgsType);
