...
public class FileResponseHandler extends BasicResponseHandler {
	 ...
	 *            レスポンスを保存するファイル
	 */
	public FileResponseHandler(String url, String encoding, int connectionTimeoutMillis, int socketTimeoutMillis,
			Map<String, String> paramMap, String userAgent, File file) {
